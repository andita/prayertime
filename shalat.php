...
echo "<tr><td>Subuh <td>".date("H:i:s", strtotime("$shalat[fajr] am"));


$dhuhr = date("H", strtotime($shalat['dhuhr']));

if($dhuhr=11) {
echo "<tr><td>Zuhur <td>".date("H:i:s", strtotime("$shalat[dhuhr] am"));	
}
if($dhuhr=12) {
echo "<tr><td>Zuhur <td>".date("H:i:s", strtotime("$shalat[dhuhr] pm"));	
}

echo "<tr><td>Ashr <td>".date("H:i:s", strtotime("$shalat[asr] pm"));
echo "<tr><td>Maghrib <td>".date("H:i:s", strtotime("$shalat[maghrib] pm"));
echo "<tr><td>Isya <td>".date("H:i:s", strtotime("$shalat[isha] pm"));
echo "</table>";
